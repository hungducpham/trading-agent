...
class SimpleStrategy(TradingStrategy):
    ...
    def perform_action(self, date, data, portfolio, cash):
        ...
        for symbol in portfolio.keys():
            ...
            # Buy a part of the share if price decreased
            if today_close < yesterday_close:
                shares_to_buy = int((updated_cash / today_close) * self.BUY_PERCENTAGE)
                if shares_to_buy > 0:
            ...
            # Sell a part of the shares if price increase
            elif today_close < yesterday_close and updated_portfolio.get(symbol, 0) > 0:
                shares_to_sell = int(updated_portfolio[symbol] * self.SELL_PERCENTAGE)
